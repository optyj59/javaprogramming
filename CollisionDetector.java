...
public class CollisionDetector {
	...
	public void checkTile(obj OBJ) {
		...
		case "down":
			...
			if(gp.tileM.tile[(objtopROW+objbottomROW)/2][(objleftCOL+objrightCOL)/2].endgame==true || gp.tileM.tile[(objtopROW+objbottomROW)/2][(objleftCOL+objrightCOL)/2].endgame==true) {
